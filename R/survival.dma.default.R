...
#dynamic cox regression for each candidate model
...
#outputs#
            ...
            #theta K by time by d array of dynamic cox regression estimates for each model
            #vartheta K by time by d array of dynamic cox regression variances for each model
